...
var allnews = {
		news:[
			{id:9527,time:'2017-10-03',title:'死亡不是永别，忘记才是',content:'作为一个郁郁寡话的创作者，时常会思考为什么皮克斯能把最简单作为一个郁郁寡话的创作者，时常会思考为什么皮克斯能把最简单作为一个郁郁寡话的创作者，时常会思考为什么皮克斯能把最简单作为一个郁郁寡话的创作者，时常会思考为什么皮克斯能把最简单的故事讲得那么极致，'},
